...
export default function specialInventory(props) {
  ...
  return (
    <>
      ...
      <InventoryFilterContext
        ...
        setPosts={setPosts}
      >
        <div className="row justify-content-center p-0 m-0 w-100 pb-5">
          <div className="col-xl-10 col-md-11 col-12 p-0 m-0 ">
            <div className="p-0 m-0 w-100 row justify-content-center px-md-4 py-5 px-lg-0 px-xl-5 ">
...
export async function getServerSideProps(ctx) {
  ...
  const { data: advanceSearchData, status: advanceSearchStatus } =
    await httpRequest(
      "GET",
      `/api/dealership/advance/search/vehicles/get/${domain}?is_it_special=1`,
      {},
      {},
      false
    );
